...
train_data.read_train_from_file(os.path.join("..","Data","datasets","mushroom.train"))
...
test_data.read_train_from_file(os.path.join("..","Data","datasets","mushroom.test"))
