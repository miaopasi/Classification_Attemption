...
# savez("wifi_floor.npz", floor=floor_data, wifilist=wifi_bld_list)
...
#
# res = util.fann_wifi_test_recovered(class_num, floor_data['F1'].wifi_bld_mat, True, 'wifi_floor.conf')
# print res
